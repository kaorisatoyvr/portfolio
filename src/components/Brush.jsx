...
const Brush = () => {
    ...
    return (
        ...
        className={`brush_1 ${animate ? 'is-animated' : ''} w-[100px] sm:w-[160px] md:w-[200px] absolute top-[10%] left-[5%] sm:top-[20%] sm:left-[15%] z-0`}
        src={brush}
        alt="brush" />
        ...
        animate={{ rotate: 90 }}
        transition={{ type: "spring", duration: 10, bounce: 0.5}}
        className={`brush_2 ${animate ? 'is-animated' : ''} w-[60px] sm:w-[80px] md:w-[100px] absolute right-[10%] top-[20%] sm:right-[30%] z-01`}
        src={brush}
        alt="brush" />
        ...
        <figure className={`brush1 ${animate ? 'is-animated' : ''}`}>
        <img src={brush} alt="pink medium brush animation" />
        </figure>
        <figure className={`brush2 ${animate ? 'is-animated' : ''}`}>
        <img src={brush} alt="pink small brush animation" />
        </figure>
        <figure className={`brush3 ${animate ? 'is-animated' : ''}`}>
        <img src={brush} alt="pink large brush animation" />
        </figure>
        <figure className={`brush4 ${animate ? 'is-animated' : ''}`}>
        <img src={brush} alt="pink small2 brush animation" />
        </figure>
        <figure className={`brush5 ${animate ? 'is-animated' : ''}`}>
        <img src={brush2} alt="blue medium brush animation" />
        </figure>
        <figure className={`brush6 ${animate ? 'is-animated' : ''}`}>
        <img src={brush2} alt="blue small brush animation" />
        </figure>
        <figure className={`brush7 ${animate ? 'is-animated' : ''}`}>
        <img src={brush2} alt="blue large brush animation" />
        </figure>
